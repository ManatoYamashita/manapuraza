<template>
  <div v-if="creative" class="creative-detail">
    <!-- 戻るボタン -->
    <NuxtLink to="/creatives" class="back-link">
...
/**
 * CreativeDetail - 作品詳細ページ（Nuxt 3対応版）
 * Nuxt 3変更点:
 * - useRoute, useI18n, useHead（自動インポート）
 * - useCreatives composableでデータ取得
 * - TypeScript型定義対応
 */
  ...
  // detailDefaults定義（useCreativesから独立）
