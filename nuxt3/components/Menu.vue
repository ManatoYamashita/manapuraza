        ...
        <div class="mobile-menu-shell" :class="{ open: isMobileMenuOpen }">
          ...
          >
            <li class="mobile-menu-item">
              <NuxtLink to="/about" class="mobile-menu-link">{{ $t('navbar.menu.about') }}</NuxtLink>
            </li>
            <li class="mobile-menu-item">
              <NuxtLink to="/creatives" class="mobile-menu-link">{{ $t('navbar.menu.creatives') }}</NuxtLink>
            </li>
            <li class="mobile-menu-item">
              <NuxtLink to="/contact" class="mobile-menu-link">{{ $t('navbar.menu.contact') }}</NuxtLink>
            </li>
          </ul>
        </div>
      </nav>
...
<script>
/**
 * Menu.vue - 統合レスポンシブナビゲーション（Nuxt 3対応版）
 *
 * Nuxt 3変更点:
 * - NuxtLink（自動インポート）
 * - useRoute, useRouter, useI18n（自動インポート）
 * - アセットパス ~/assets/
 */
...
export default {
  name: 'AppMenu',
  setup() {
    // Nuxt 3自動インポート（useRoute, useRouter, useI18n）
