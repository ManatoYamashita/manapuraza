      ...
      <div id="main-contents">
        ...
        <h3>Programming / Web</h3>
          ...
          <ul>
            ...
            <li><a href="http://tmana.sub.jp/numeron/dirs/src/" target="_blank">NUMERON&nbsp;<fa :icon="['fas', 'arrow-up-right-from-square']" class="fa" /></a>（論理数学ゲーム）</li>
...
a:hover {
  background-color: transparent;
	text-shadow: #4faef2 0px 0px 10px;
}
.fa {
  font-size: .6rem;
  margin-left: .2rem;
