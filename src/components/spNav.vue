<template>
    <div id="main">
        <nav class="menu-circle-social">
            ...
            <label class="menu-circle-open-button" for="menu-open">
            ...
            <router-link to="/works" class="menu-circle-item">
